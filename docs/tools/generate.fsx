...
let githubLink = "http://github.com/stuarthillary/DisqusN"

// Specify more information about your project
let info =
  [ "project-name", "DisqusN"
    "project-author", "Stuart Hillary"
    "project-summary", "A Disqus API client for .NET (with functional tendencies)"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/DisqusN" ]
